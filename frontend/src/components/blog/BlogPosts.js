            ...
            <div>
                <div className="flex flex-col-reverse">
                    ...
                    <div className="w-full bg-[url('./plus.svg')] dark:bg-[url('./plus_dark.svg')] flex items-start flex-col bg-top mt-3 mb-1 sm:mb-5 pt-1 pb-3 sm:pt-3 sm:pb-7">
                        ...
                        <p className="ml-2 mr-2 text-black dark:text-white text-sm sm:text-base sm:ml-7 sm:mr-7">Mon blog personnel, centré essentiellement sur le développement web.</p>
                    </div>
                </div>
