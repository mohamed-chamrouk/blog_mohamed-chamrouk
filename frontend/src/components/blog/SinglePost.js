    ...
    return (
        <div className="pb-7">
            ...
            <div className="mt-3 mb-3 flex flex-col p-2 border-b-[4px] border-gray-50 dark:border-gray-800">
                ...
                <Link role="link-to-post" to={returnLink} className="dark:text-white transition-colors hover:text-cyan-700 dark:hover:text-cyan-500 font-bold text-xl sm:text-3xl pb-2 sm:pb-3" href="#">{title}</Link>
